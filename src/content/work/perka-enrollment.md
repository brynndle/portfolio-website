...
order: 5
role: "UX/UI Design"
methods: "User Interviews, Analytics Research, UI Design"
figures:
  - src: "/images/projects/perka-enrollment/5s.jpg"
    caption: "Our second iteration had a lovely animation but we decided it was still a little too ambiguous. Users still have too many choices plopped in front of them."
  - src: "/images/projects/perka-enrollment/Tool-Tip-Copy-3.png"
    caption: "Version 3: the winning concept, a pop-over feature announcement."
  - src: "/images/projects/perka-enrollment/List-View-Copy-6.png"
    caption: "Version 3, expanded — tapping 'Learn More' resolves any confusion."
---
...
The initial concept for the presentation of the claim code feature. We decided to try presenting the feature on a splash screen to guarantee our users would see it. Our analytics showed that this solution was successful in getting customers to use the enrollment helper but we also found some negatives to this design and worked on a less obtrusive version.

### Version 2

Our second iteration removed the splash screen and create account function but still advertised the "Claim Code" feature. User testing the prototype revealed this presentation to be confusing for folks who did not have a receipt. They thought you needed one to begin using the app.

### Version 3

The winning concept took the form of a pop-over feature announcement. The user gets an idea of what the feature is, if it concerns them, and can then move on without confusion or tap “Learn More” if they are confused.
